...
namespace
{
    const char* const WINDOW_TITLE = "CS 330 Assignment 5"; // Macro for window title
...
int main(int argc, char* argv[])
{
    ...
    // Load texture
    //This is the brick texture required for texturing the pyramid. The brick texture used will repeat on the pyramid. 
    const char* texFilename = "images/Brick3.jpg";
...
void UProcessInput(GLFWwindow* window)
{
    ...
    //These keys will change the mapping of the brick texture. The first key for repeat is default for the pyramid.
...
void URender()
{
    ...
    glm::mat4 rotation = glm::rotate(45.0f, glm::vec3(1.0, 5.0f, 1.0f));
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] = {
        ...
        //These are the vertices to create the pyramid. All sides are initialized with texture coordinates to ensure the texture covers the entire pyramid. 
